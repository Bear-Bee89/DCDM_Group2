# app.R
# IMPC Knockout Mouse Phenotype Explorer
# Now with elbow method for k-means clustering
...
# If running locally, set your working directory here:
# setwd("/path/to/your/GP1/")
