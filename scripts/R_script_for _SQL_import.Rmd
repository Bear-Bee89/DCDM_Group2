...
### Set working directory if files are stored locally
...
4. **Complete linkage table**: Combines procedure mappings with parameter identifiers to create a three-way junction table
...
gene_diseases_for_sql <- disease %>%
  ...
  distinct() %>%
  # keep only gene IDs that exist in Genes_for_SQL 
